...
export const InstructorPanel: React.FC<Props> = ({ currentUserId }) => {
  ...
  const profile = db.instructorProfiles.find(p => p.user_id === currentUserId);

  useEffect(() => {
    setMyCourses(repo.getByInstructor(currentUserId));
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [currentUserId, editorCourseId]); // Reload when switching back from editor
