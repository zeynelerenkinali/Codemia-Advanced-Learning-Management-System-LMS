...
export interface Enrollment {
  ...
  course_id: number;
  enrolled_at: string;
  last_accessed: string; // New Field
}
...
// View Types
export type ViewState = 'home' | 'courses' | 'course_detail' | 'student_courses' | 'lesson' | 'quiz' | 'admin' | 'instructor_panel' | 'become_instructor' | 'profile_settings' | 'sql_spec' | 'patterns';
